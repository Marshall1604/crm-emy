...
export default function CheckoutPage() {
  ...
  const plans = {
    monthly: {
      id: 'monthly',
      name: isVi ? 'Gói Pro Tháng (Monthly Pro)' : 'Pro Monthly',
      price: '$14',
      numericPrice: 14,
      ...
      features: [
        isVi ? 'Lưu trữ KHÔNG GIỚI HẠN khách hàng & công ty' : 'Unlimited client & business records',
        isVi ? 'Siêu Trợ Lý Emly AI (Thuế & Luật Mỹ 50 Bang)' : 'Emly AI 50-State Tax & Insurance Engine',
        isVi ? 'AI Báo Cáo Phân Tích Khách Hàng Thông Minh' : 'AI-Powered Client & Revenue Analytics',
        isVi ? 'Hệ thống gửi Email Marketing tự động hàng loạt' : 'Bulk Automated Client Marketing Mail',
        isVi ? 'Module Quản Lý Bảo Hiểm (Insurance Services Pro)' : 'Insurance Services Pro Management',
      ],
    },
    yearly: {
      id: 'yearly',
      name: isVi ? 'Gói Pro Năm (Annual Pro)' : 'Pro Annual',
      price: '$142',
      numericPrice: 142,
      period: isVi ? '/năm (Tiết kiệm 20%)' : '/year (Save 20%)',
      badge: isVi ? 'TIẾT KIỆM 20% • KHUYÊN DÙNG' : 'SAVE 20% • BEST VALUE',
      desc: isVi ? 'Lựa chọn tối ưu nhất cho văn phòng thuế bứt phá doanh thu.' : 'Best value for growing accounting & tax offices.',
      features: [
        isVi ? 'Toàn bộ tính năng cao cấp của gói Pro' : 'Everything included in Pro Suite',
        isVi ? 'Tiết kiệm 20% chi phí (~ $11.8/tháng)' : 'Save 20% compared to monthly plan',
        isVi ? 'Không giới hạn hồ sơ khách hàng & doanh nghiệp' : 'Unlimited clients & corporate entities',
        isVi ? 'Siêu Trợ Lý Emly AI & Báo Cáo AI Thông Minh' : 'Emly AI & AI Practice Analytics',
        isVi ? 'Hỗ trợ kỹ thuật 1-1 trực tiếp 24/7 qua WhatsApp' : 'Priority 24/7 1-on-1 WhatsApp Support',
      ],
    },
    lifetime: {
      id: 'lifetime',
      name: isVi ? 'Bản Quyền Trọn Đời (Lifetime License)' : 'Lifetime License',
      price: isVi ? 'Liên hệ WhatsApp' : 'Contact WhatsApp',
      numericPrice: 0,
      period: isVi ? 'bản quyền vĩnh viễn' : 'lifetime permanent access',
      badge: isVi ? '👑 BẢN QUYỀN TRỌN ĐỜI' : '👑 LIFETIME ACCESS',
      desc: isVi ? 'Sở hữu vĩnh viễn, liên hệ WhatsApp để nhận báo giá ưu đãi.' : 'Permanent unlimited access, contact WhatsApp for quote.',
      features: [
